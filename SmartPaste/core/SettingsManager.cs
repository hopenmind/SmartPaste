...
namespace SmartPaste
{
    public class AppSettings
    {
        ...
        // When true, minimizing the window hides it entirely, leaving only the tray icon.
        public bool MinimizeToTray { get; set; } = false;

        // Theme (brand: "Aubergine" | "Prune"; mode: "Light" | "Dark")
        public string ThemeBrand { get; set; } = "Aubergine";
        public string ThemeMode { get; set; } = "Dark";

        // Function Toggles
        public bool EnableSmartPaste { get; set; } = true;
        public bool EnableSmartCopy { get; set; } = false;
        ...
        // Smart Paste Intercept (override native Ctrl+V when SmartCopy content exists)
        public bool EnablePasteIntercept { get; set; } = true;
